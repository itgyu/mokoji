    ...
    <div className="min-h-screen bg-gray-50 pb-28 max-w-md mx-auto">
      ...
      {currentPage === 'home' && (
        <div className="bg-[#FFFBF7]">
          ...
          <header className="sticky top-0 bg-white z-10 safe-top">
            <div className="px-4 py-5 sm:px-5 sm:py-3 md:py-6 flex justify-between items-center border-b border-stone-100">
              <div className="flex items-center gap-2 sm:gap-3">
                <MapPin className="w-6 h-6 sm:w-7 sm:h-7 text-[#FF9B50]" strokeWidth={2.5} />
                <span className="font-bold text-xl sm:text-base md:text-lg md:text-xl md:text-2xl tracking-tight text-[#292524]">
              ...
              <div className="flex gap-1">
                <button className="p-3 hover:bg-gray-50 rounded-xl active:scale-95 transition-all">
                  <Bell className="w-6 h-6 text-[#78716C]" strokeWidth={2} />
                </button>
                <button className="p-3 hover:bg-gray-50 rounded-xl active:scale-95 transition-all">
                  <Settings className="w-6 h-6 text-[#78716C]" strokeWidth={2} />
                </button>
              </div>
            </div>
          </header>

          <div className="px-5 py-3 md:py-6 space-y-5">
            {/* 내 동네 크루 섹션 - 당근마켓 스타일 */}
            <div className="mb-6">
              {/* 헤더 */}
            ...
            <div className="bg-white rounded-3xl p-7 shadow-sm border border-stone-100">
              <div className="flex justify-between items-center mb-6">
                <div className="flex items-center gap-3">
                  ...
                  <h2 className="text-base md:text-lg md:text-xl md:text-2xl font-bold tracking-tight text-[#292524]">다가오는 일정</h2>
                </div>
                <button
                  onClick={() => {
                  ...
                  {mySchedules.slice(0, 3).map((schedule) => (
                    ...
                    >
                      <div className="flex justify-between items-start mb-4">
                        <h3 className="font-bold text-base md:text-lg md:text-xl tracking-tight text-[#292524] leading-tight">{schedule.title}</h3>
      ...
      {currentPage === 'category' && (
        <div className="bg-[#FFFBF7] min-h-screen">
          <header className="sticky top-0 bg-white z-10 safe-top border-b border-stone-100">
            <div className="px-4 py-5 sm:px-3 md:px-6 sm:py-3 md:py-6 flex justify-between items-center">
              <div className="flex items-center gap-2 sm:gap-3">
                <MapPin className="w-6 h-6 sm:w-7 sm:h-7 text-[#FF9B50]" strokeWidth={2.5} />
                <span className="font-bold text-xl sm:text-base md:text-lg md:text-xl md:text-2xl tracking-tight text-[#292524]">
                  {userProfile?.locations && userProfile.locations.length > 0
          ...
          <div className="px-5 py-3 md:py-6">
            <h2 className="text-base md:text-lg md:text-xl md:text-2xl font-bold tracking-tight text-[#292524] mb-5">크루 찾기</h2>
                    ...
                    >
                      <div className="flex items-center gap-2 md:gap-4">
                        ...
                        <div className="flex-1 min-w-0">
                          {org.subtitle && (
                            <p className="text-xs font-bold text-[#A8A29E] mb-1 truncate">{org.subtitle}</p>
                          )}
                          <h4 className="text-base md:text-lg font-bold tracking-tight text-[#292524] mb-1 truncate">
                            {org.name}
                          </h4>
                          <div className="flex items-center gap-2 flex-wrap">
                            {(org.categories || [org.category]).filter(Boolean).map((cat, idx) => (
                              <span key={idx} className="inline-flex items-center px-2 py-1 bg-[#F5F5F4] text-[#78716C] text-xs rounded-lg font-medium">
                                {cat}
                              </span>
                            ))}
                          </div>
                        </div>
                        <div className="text-[#FF9B50] text-base md:text-lg md:text-xl">→</div>
                      </div>
                    </div>
                  ))}
                </div>
              ...
              <div className="space-y-3">
                {organizations.map((org) => {
                  ...
                  return (
                    ...
                    >
                      <div className="flex items-center gap-2 md:gap-4">
                        <div className="w-12 h-12 md:w-16 md:h-16 rounded-2xl overflow-hidden flex-shrink-0 bg-stone-100">
                          {org.avatar ? (
                            <img src={org.avatar} alt={org.name} className="w-full h-full object-cover" />
                          ) : (
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <h3 className="text-base md:text-lg font-bold tracking-tight text-[#292524] mb-1 truncate">
                            {org.name}
                          </h3>
      ...
      {currentPage === 'schedules' && (
        <div className="bg-[#FFFBF7] min-h-screen">
                ...
                <button
                  ...
                  className={`px-4 py-2 rounded-full text-sm font-bold whitespace-nowrap transition-all flex-shrink-0 ${
                    scheduleFilter === 'all'
                      ...
                      : 'bg-[#F5F5F4] text-[#292524] hover:bg-[#E5E8EB]'
                  }`}
                >
          ...
          <div className="px-5 py-3 md:py-6 space-y-3">
            {(() => {
              // 필터 적용
                    ...
                    return (
                      <div key={orgId}>
                        ...
                        <div className="flex items-center justify-between mb-3">
                          <h2 className="text-base md:text-lg font-bold text-[#292524]">
                            {org?.name || '알 수 없는 크루'}
                          </h2>
                          <span className="text-sm text-[#A8A29E] font-semibold">
                        ...
                        <div className="space-y-3">
                          {orgSchedules.map((schedule) => {
                            ...
                            return (
                              ...
                              >
                                <div className="flex justify-between items-start mb-4">
                                  <h3 className="font-bold text-base md:text-lg tracking-tight text-[#292524] flex-1">{schedule.title}</h3>
        ...
        <div className="bg-[#FFFBF7] min-h-screen">
          {!selectedOrg ? (
            ...
            <div className="px-3 md:px-6 pb-6 grid grid-cols-3 gap-3">
              ...
              >
                <div className="text-base md:text-lg md:text-xl md:text-2xl md:text-3xl font-bold tracking-tight">{upcomingSchedules.length}</div>
              ...
              >
                <div className="text-base md:text-lg md:text-xl md:text-2xl md:text-3xl font-bold tracking-tight">{mySchedules.length}</div>
              ...
              >
                <div className="text-base md:text-lg md:text-xl md:text-2xl md:text-3xl font-bold tracking-tight">{upcomingSchedules.length - mySchedules.length}</div>
                <div className="text-xs font-bold mt-1 opacity-80">미참여</div>
              </button>
            </div>
          </header>

          <div className="px-5 py-3 md:py-6 space-y-3 md:space-y-6">
            {/* 다가오는 일정 */}
            <div>
              <h3 className="text-base md:text-lg font-bold tracking-tight text-[#292524] mb-4">다가오는 일정</h3>
              <div className="space-y-3">
                {(() => {
                  let filteredSchedules = upcomingSchedules
                  const myName = userProfile?.name || user?.displayName || '익명'
            ...
            {pastSchedules.length > 0 && (
              <div className="mt-8">
                <h3 className="text-base md:text-lg font-bold text-gray-500 mb-3 px-2">지난 일정</h3>
                <div className="space-y-3">
                    ...
                    return (
                      ...
                      >
                        <div className="flex justify-between items-start mb-3">
                          <h3 className="font-bold text-base md:text-lg text-stone-600">{schedule.title}</h3>
                          <span className="text-xs bg-gray-200 text-stone-600 px-3 py-1 rounded-full font-semibold">
                            {schedule.type}
                          </span>
                        </div>
          ...
          <div className="fixed bottom-32 right-5 flex flex-col gap-2 md:gap-4 z-30">
            <button
              ...
              className="w-12 h-12 md:w-16 md:h-16 bg-white border-2 border-[#FF9B50] text-[#FF9B50] rounded-full shadow-lg active:scale-95 transition-transform flex items-center justify-center"
            >
              <Users className="w-7 h-7" />
            </button>
            <button
              onClick={() => setShowCreateSchedule(true)}
              className="w-12 h-12 md:w-16 md:h-16 bg-[#FF9B50] hover:bg-[#FF8A3D] text-white rounded-full shadow-lg text-base md:text-lg md:text-xl md:text-2xl md:text-3xl font-bold active:scale-95 transition-transform"
            >
              +
            </button>
          </div>
      ...
      {showMemberList && (
        <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-2xl max-w-md w-full max-h-[80vh] overflow-hidden flex flex-col">
            <div className="bg-[#FF9B50] text-white p-3 md:p-6">
              <div className="flex justify-between items-center mb-2">
                <div className="flex items-center gap-3">
                  <h2 className="text-base md:text-lg md:text-xl md:text-2xl font-bold">CREW MEMBERS</h2>
                  <button
                    onClick={() => selectedOrg && fetchMembers(selectedOrg.id)}
                    className="text-white text-base md:text-lg hover:opacity-80 bg-white/20 px-3 py-1 rounded-lg"
                  >
                    ↻
                  </button>
                </div>
                <button
                  ...
                  className="text-white text-base md:text-lg md:text-xl md:text-2xl hover:opacity-80"
                >
                  ×
                </button>
              </div>
                        ...
                        <div className="flex-1">
                          ...
                          <p className="text-xs text-stone-600 mt-0.5">
                            {daysSinceLastParticipation === null ? (
                              ...
                              <span className="text-[#FF9B50] font-semibold">오늘 참여</span>
                            ) : (
                              <span className={daysSinceLastParticipation >= 90 ? 'text-red-500' : daysSinceLastParticipation >= 60 ? 'text-orange-500' : 'text-stone-600'}>
                        ...
                        {isCaptain && !isCurrentUser && (
                          <div className="flex gap-1">
                            <button
                              ...
                              className="px-2 py-1 text-xs bg-[#FF9B50] text-white rounded-lg hover:bg-[#FF8A3D]"
                            >
                              수정
                            </button>
                            <button
                              onClick={() => setEditingMember(member)}
                              className="px-2 py-1 text-xs bg-orange-500 text-white rounded-lg hover:bg-blue-600"
                            >
                              역할
                            </button>
                            <button
      ...
      {selectedSchedule && (
        ...
        >
          <div className="bg-white rounded-t-3xl sm:rounded-3xl max-w-lg w-full overflow-hidden my-auto shadow-2xl animate-slideUp">
            ...
            {/* 헤더 */}
            <div className="px-3 md:px-6 pt-5 pb-4 border-b border-stone-100">
              <div className="flex justify-between items-start mb-3">
                <div className="flex-1">
                  <h2 className="text-base md:text-lg md:text-xl md:text-2xl font-bold tracking-tight text-[#292524] leading-tight mb-2">
                    {selectedSchedule.title}
                  </h2>
                  <span className="inline-block text-xs font-bold bg-[#F5F5F4] text-[#78716C] px-3 py-1.5 rounded-lg">
                    {selectedSchedule.type}
                  </span>
                </div>
                <button
                  onClick={() => setSelectedSchedule(null)}
                  className="p-2 hover:bg-stone-100 rounded-xl active:scale-95 transition-all -mr-2"
                >
                  <span className="text-base md:text-lg md:text-xl md:text-2xl text-[#A8A29E]">×</span>
                </button>
              </div>
            </div>

            <div className="px-3 md:px-6 py-5 space-y-3 md:space-y-6 max-h-[70vh] overflow-y-auto">
              {/* 일정 정보 카드 */}
              ...
              <div>
                ...
                {selectedSchedule.participants && selectedSchedule.participants.length > 0 && (
                  <div className="flex flex-wrap gap-2">
                    {selectedSchedule.participants.map((name) => (
                      <div key={name} className="bg-[#F5F5F4] px-4 py-2.5 rounded-xl flex items-center gap-2 hover:bg-[#E5E8EB] transition-colors">
                        <span className="text-sm font-bold text-[#292524]">{name}</span>
                        {(userProfile?.role === 'captain' || userProfile?.role === 'staff' || selectedSchedule.createdByUid === user?.uid) && (
                          <button
                            ...
                            className="text-[#A8A29E] hover:text-red-500 font-bold text-base md:text-lg leading-none active:scale-95 transition-all"
                          >
                            ×
                          </button>
                        )}
                ...
                {(userProfile?.role === 'captain' || userProfile?.role === 'staff' || selectedSchedule.createdByUid === user?.uid) && (
                  <button
                    ...
                    className="mt-3 text-sm text-[#FF9B50] hover:text-[#FF8A3D] font-bold py-1 active:scale-95 transition-all"
                  >
                ...
                {managingParticipants && members.filter(m => !selectedSchedule.participants?.includes(m.name)).length > 0 && (
                  <div className="mt-3 p-4 bg-[#FFFBF7] rounded-2xl max-h-40 overflow-y-auto">
                    <div className="text-xs font-bold text-[#A8A29E] mb-3">멤버를 클릭하여 추가</div>
                    <div className="flex flex-wrap gap-2">
                      {members.filter(m => !selectedSchedule.participants?.includes(m.name)).map(member => (
                        <button
                          ...
                          className="text-sm font-bold bg-white px-4 py-2 rounded-xl hover:bg-[#FF9B50] hover:text-white border border-[#E5E8EB] active:scale-95 transition-all"
                        >
                          + {member.name}
                        </button>
                      ))}
              ...
              <div className="border-t border-stone-100 pt-6">
                        ...
                        <div className="flex justify-between items-start mb-2">
                          ...
                          {(comment.userUid === user?.uid || userProfile?.role === 'captain' || userProfile?.role === 'staff') && (
                            <button
                              ...
                              className="text-[#A8A29E] hover:text-red-500 text-base md:text-lg md:text-xl leading-none active:scale-95 transition-all"
                            >
                              ×
                            </button>
                          )}
                        </div>
                        <div className="text-sm text-[#292524] leading-relaxed mb-2">{comment.text}</div>
                ...
                <div className="flex gap-2">
                  <input
                    ...
                    className="flex-1 px-4 py-3 border-2 border-[#E5E8EB] rounded-xl text-sm focus:border-[#FF9B50] focus:outline-none transition-colors"
                  />
                  <button
                    onClick={() => handleAddComment(selectedSchedule)}
                    className="px-5 py-3 bg-[#FF9B50] text-white rounded-xl text-sm font-bold hover:bg-[#FF8A3D] active:scale-95 transition-all"
                  >
                    등록
                  </button>
                </div>
              ...
              {(userProfile?.role === 'captain' || userProfile?.role === 'staff' || selectedSchedule.createdByUid === user?.uid) && (
                <div className="flex gap-3">
                  <button
                    ...
                    className="flex-1 bg-[#FF9B50] text-white py-3.5 rounded-xl font-bold hover:bg-[#FF8A3D] transition-all active:scale-[0.98] text-sm"
                  >
                    ✏️ 수정
                  </button>
                  <button
                    onClick={() => handleDeleteSchedule(selectedSchedule)}
                    className="flex-1 bg-[#F5F5F4] text-[#F04452] py-3.5 rounded-xl font-bold hover:bg-[#FFE5E8] transition-all active:scale-[0.98] text-sm"
                  >
                    🗑️ 삭제
                  </button>
                </div>
              ...
              <div>
                {selectedSchedule.participants?.includes(userProfile?.name || user?.displayName || '익명') ? (
                  <button
                    ...
                    className="w-full bg-[#F5F5F4] text-[#F04452] py-4 rounded-2xl font-bold hover:bg-[#FFE5E8] transition-all active:scale-[0.98]"
                  >
                    참여 취소
                  </button>
                ) : (
                  <button
                    ...
                    className="w-full bg-[#FF9B50] text-white py-4 rounded-2xl font-bold hover:bg-[#FF8A3D] disabled:bg-[#E5E8EB] disabled:text-[#A8A29E] transition-all active:scale-[0.98]"
        ...
        <div className="bg-[#FFFBF7] min-h-screen pb-20">
          ...
          <header className="sticky top-0 bg-white z-10 safe-top border-b border-stone-100">
            <div className="px-4 py-4 sm:px-3 md:px-6 sm:py-5">
              <h1 className="text-xl sm:text-base md:text-lg md:text-xl md:text-2xl font-bold tracking-tight text-[#292524]">내 정보</h1>
            </div>
          </header>

          <div className="px-4 py-4 sm:px-5 sm:py-3 md:py-6 space-y-3 sm:space-y-2 md:space-y-4">
            {/* 내 동네 설정 섹션 */}
            <div className="bg-white rounded-xl sm:rounded-2xl p-4 sm:p-3 md:p-6 shadow-sm border border-stone-100">
              <h3 className="text-base sm:text-base md:text-lg font-bold tracking-tight text-[#292524] mb-3 sm:mb-4">
                내 동네 설정
              </h3>
            ...
            <div className="bg-white rounded-xl sm:rounded-2xl p-4 sm:p-3 md:p-6 shadow-sm border border-stone-100">
              <div className="text-center mb-5 sm:mb-6">
                ...
                <h2 className="text-xl sm:text-base md:text-lg md:text-xl md:text-2xl font-bold tracking-tight text-[#292524] mb-1.5 sm:mb-2">{profile.name}</h2>
                <p className="text-xs sm:text-sm text-[#A8A29E]">{profile.email}</p>
              </div>

              {/* 정보 섹션 */}
              <div className="bg-[#FFFBF7] rounded-xl sm:rounded-2xl p-4 sm:p-5 space-y-3 sm:space-y-2 md:space-y-4">
                <div>
                  <div className="text-xs font-bold text-[#A8A29E] mb-1.5 sm:mb-2">생년월일</div>
                  <div className="text-sm sm:text-base font-bold text-[#292524]">{profile.birthdate}</div>
                </div>
                <div className="h-px bg-[#E5E8EB]"></div>
                <div>
                  <div className="text-xs font-bold text-[#A8A29E] mb-1.5 sm:mb-2">성별</div>
                  <div className="text-sm sm:text-base font-bold text-[#292524]">{profile.gender}</div>
                </div>
                <div className="h-px bg-[#E5E8EB]"></div>
                <div>
                  <div className="text-xs font-bold text-[#A8A29E] mb-1.5 sm:mb-2">지역</div>
                  <div className="text-sm sm:text-base font-bold text-[#292524]">{profile.location}</div>
                </div>
                <div className="h-px bg-[#E5E8EB]"></div>
                <div>
                  <div className="text-xs font-bold text-[#A8A29E] mb-1.5 sm:mb-2">MBTI</div>
                  <div className="text-sm sm:text-base font-bold text-[#292524]">{profile.mbti || '-'}</div>
                </div>
                <div className="h-px bg-[#E5E8EB]"></div>
                <div>
                  <div className="text-xs font-bold text-[#A8A29E] mb-1.5 sm:mb-2">관심 카테고리</div>
                  <div className="flex flex-wrap gap-1.5 sm:gap-2">
                    {(profile.interestCategories || []).length > 0 ? (
                      ...
                      <span className="text-sm sm:text-base font-bold text-[#292524]">-</span>
                    )}
                  </div>
                </div>
                <div className="h-px bg-[#E5E8EB]"></div>
                <div>
                  <div className="text-xs font-bold text-[#A8A29E] mb-1.5 sm:mb-2">가입일</div>
                  <div className="text-sm sm:text-base font-bold text-[#292524]">{formatTimestamp(profile.joinDate)}</div>
                </div>
              </div>
            </div>
      ...
      {selectedAvatarUrl && (
        ...
        >
          <div className="max-w-2xl max-h-[80vh] relative">
            ...
            <button
              onClick={() => setSelectedAvatarUrl(null)}
              className="absolute top-4 right-4 w-10 h-10 bg-white/20 hover:bg-white/30 rounded-full text-white text-base md:text-lg md:text-xl md:text-2xl flex items-center justify-center"
            >
              ×
            </button>
          </div>
        ...
        <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-2xl max-w-sm w-full overflow-hidden">
            <div className="bg-gradient-to-r from-orange-500 to-blue-600 text-white p-3 md:p-6">
              <h2 className="text-base md:text-lg md:text-xl font-bold">멤버 역할 변경</h2>
            ...
            <div className="p-3 md:p-6 space-y-3">
              <button
                ...
                className="w-full py-3 bg-[#FF9B50] text-white rounded-lg font-semibold hover:bg-[#FF8A3D] transition-colors"
              >
                크루장으로 변경
              </button>
              <button
                onClick={() => handleUpdateMemberRole(editingMember, 'staff')}
                className="w-full py-3 bg-orange-500 text-white rounded-lg font-semibold hover:bg-blue-600 transition-colors"
              >
                운영진으로 변경
              </button>
              <button
                onClick={() => handleUpdateMemberRole(editingMember, 'member')}
                className="w-full py-3 bg-gray-500 text-white rounded-lg font-semibold hover:bg-stone-600 transition-colors"
              >
                일반 멤버로 변경
              </button>
              <button
                onClick={() => setEditingMember(null)}
                className="w-full py-3 bg-gray-200 text-stone-700 rounded-lg font-semibold hover:bg-gray-300 transition-colors"
              >
                취소
              </button>
            </div>
      ...
      {editingMemberInfo && (
        <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-2xl max-w-md w-full max-h-[80vh] overflow-hidden flex flex-col">
            <div className="bg-[#FF9B50] text-white p-3 md:p-6">
              <h2 className="text-base md:text-lg md:text-xl font-bold">멤버 정보 수정</h2>
            ...
            <div className="p-3 md:p-6 space-y-2 md:space-y-4 overflow-y-auto flex-1">
              <div>
              ...
              <div>
                ...
                <div className="grid grid-cols-2 gap-2">
                  ...
                  <select
                    ...
                    className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#FF9B50] disabled:bg-stone-100 disabled:cursor-not-allowed"
                  >
              ...
              <div>
                <label className="block text-sm font-medium text-stone-700 mb-1">MBTI</label>
                <input
                  type="text"
                  value={editForm.mbti}
            ...
            <div className="p-3 md:p-6 border-t flex gap-3">
              <button
                ...
                className="flex-1 py-3 bg-[#FF9B50] text-white rounded-lg font-semibold hover:bg-[#FF8A3D] transition-colors"
              >
                저장
              </button>
              <button
                onClick={() => setEditingMemberInfo(null)}
                className="flex-1 py-3 bg-gray-200 text-stone-700 rounded-lg font-semibold hover:bg-gray-300 transition-colors"
              >
                취소
              </button>
            </div>
      ...
      {editingOrg && (
        <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-2xl max-w-md w-full max-h-[80vh] overflow-hidden flex flex-col">
            <div className="bg-[#FF9B50] text-white p-3 md:p-6">
              <h2 className="text-base md:text-lg md:text-xl font-bold">크루 정보 수정</h2>
              <p className="text-sm opacity-90 mt-1">{editingOrg.name}</p>
            </div>

            <div className="p-3 md:p-6 space-y-2 md:space-y-4 overflow-y-auto flex-1">
              <div>
                <label className="block text-sm font-medium text-stone-700 mb-1">크루명 *</label>
                <input
                  type="text"
                  value={orgForm.name}
              ...
              <div>
                <label className="block text-sm font-medium text-stone-700 mb-1">크루 소제목</label>
                <input
                  type="text"
              ...
              <div>
                <label className="block text-sm font-medium text-stone-700 mb-1">크루 설명 *</label>
                <textarea
              ...
              <div>
                <label className="block text-sm font-medium text-stone-700 mb-2">카테고리 * (중복 선택 가능)</label>
              ...
              {/* 크루 활동 지역 */}
              <div>
                <label className="block text-sm font-medium text-stone-700 mb-2">크루 활동 지역 (선택)</label>
                <div className="space-y-2">
                  {orgForm.location ? (
                    ...
                    <button
                      ...
                      className="w-full py-2.5 px-4 bg-white border border-gray-300 text-stone-700 rounded-lg font-medium hover:bg-gray-50 active:scale-95 transition-all disabled:opacity-50"
                    >
                      {settingLocation ? (
              ...
              <div>
                <label className="block text-sm font-medium text-stone-700 mb-2">크루 메인사진</label>
                <div className="space-y-2">
                  {orgAvatarFile && (
                    <div className="p-3 bg-gray-50 rounded-lg border border-gray-200 flex items-center justify-between">
                      <div className="flex items-center gap-2">
                        <span className="text-base md:text-lg md:text-xl md:text-2xl">📷</span>
                        <span className="text-sm text-stone-700">{orgAvatarFile.name}</span>
                      </div>
                      <button
                        type="button"
                  ...
                  <div className="flex gap-2">
                    <label className="flex-1 py-2.5 px-4 bg-white border border-gray-300 text-stone-700 rounded-lg font-medium text-center cursor-pointer hover:bg-gray-50 active:scale-95 transition-all">
                      📸 사진 촬영
                      <input
                        type="file"
                        accept="image/*"
            ...
            <div className="p-3 md:p-6 border-t space-y-3">
              <div className="flex gap-3">
                <button
        ...
        <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-2xl max-w-md w-full max-h-[80vh] overflow-hidden flex flex-col">
            <div className="bg-gradient-to-r from-[#FF9B50] to-[#2563EB] text-white p-3 md:p-6">
              <h2 className="text-base md:text-lg md:text-xl font-bold">새 크루 만들기</h2>
            ...
            <div className="p-3 md:p-6 border-t flex gap-3">
              <button
                ...
                className="flex-1 py-3 bg-gradient-to-r from-[#FF9B50] to-[#2563EB] text-white rounded-lg font-semibold hover:opacity-90 transition-opacity"
              >
                크루 생성
              </button>
              <button
      ...
      {editingMyProfile && (
        <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-2xl max-w-md w-full max-h-[80vh] overflow-hidden flex flex-col">
            <div className="bg-[#FF9B50] text-white p-3 md:p-6">
              <h2 className="text-base md:text-lg md:text-xl font-bold">내 프로필 수정</h2>
            </div>
      ...
      {editingSchedule && (
        <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-2xl max-w-md w-full max-h-[80vh] overflow-hidden flex flex-col">
            <div className="bg-gradient-to-r from-orange-500 to-blue-600 text-white p-3 md:p-6">
              <div className="flex justify-between items-center mb-2">
                <h2 className="text-base md:text-lg md:text-xl md:text-2xl font-bold">일정 수정</h2>
                <button
            ...
            <div className="p-3 md:p-6 space-y-2 md:space-y-4 overflow-y-auto flex-1">
              <div>
                <label className="block text-sm font-medium text-stone-700 mb-1">일정 제목 *</label>
                <input
                  type="text"
              ...
              <div>
                <label className="block text-sm font-medium text-stone-700 mb-1">날짜 *</label>
                <input
                  type="date"
                ...
                {editScheduleForm.date && (
                  <p className="text-sm text-stone-600 mt-1">현재 날짜: {editScheduleForm.date.includes('-') ? new Date(editScheduleForm.date).toLocaleDateString('ko-KR', { year: 'numeric', month: 'numeric', day: 'numeric', weekday: 'short' }) : editScheduleForm.date}</p>
                )}
              </div>

              <div>
                <label className="block text-sm font-medium text-stone-700 mb-1">시간 *</label>
                <input
                  type="time"
              ...
              <div>
                <label className="block text-sm font-medium text-stone-700 mb-1">장소 *</label>
                <input
                  type="text"
            ...
            <div className="p-3 md:p-6 border-t flex gap-3">
              <button
                ...
                className="flex-1 py-3 bg-gradient-to-r from-orange-500 to-blue-600 text-white rounded-lg font-semibold hover:from-blue-600 hover:to-blue-700 transition-colors"
              >
                수정 완료
              </button>
              <button
      ...
      {showCreateSchedule && (
        <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-2xl max-w-md w-full max-h-[80vh] overflow-hidden flex flex-col">
            <div className="bg-[#FF9B50] text-white p-3 md:p-6">
              <div className="flex justify-between items-center mb-2">
                <h2 className="text-base md:text-lg md:text-xl md:text-2xl font-bold">일정 생성</h2>
                <button
            ...
            <div className="p-3 md:p-6 space-y-2 md:space-y-4 overflow-y-auto flex-1">
              ...
              <div>
                ...
                {createScheduleForm.date && (
                  <p className="text-sm text-stone-600 mt-1">선택된 날짜: {new Date(createScheduleForm.date).toLocaleDateString('ko-KR', { year: 'numeric', month: 'numeric', day: 'numeric', weekday: 'short' })}</p>
                )}
              </div>
            ...
            <div className="p-3 md:p-6 border-t flex gap-3">
              <button
                ...
                className="flex-1 py-3 bg-[#FF9B50] text-white rounded-lg font-semibold hover:bg-[#FF8A3D] transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
              >
                생성
              </button>
              <button
          ...
          {[
            ...
            <button
              ...
              className={`flex-1 py-3 flex flex-col items-center gap-1 active:scale-95 transition-all ${
                currentPage === id ? 'text-[#FF9B50]' : 'text-[#A8A29E]'
              }`}
            >
