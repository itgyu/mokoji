...
exports.onScheduleUpdate = void 0;
 ...
 */
exports.onScheduleUpdate = (0, firestore_1.onDocumentUpdated)('org_schedules/{scheduleId}', async (event) => {
    ...
    if (beforeStartTime !== afterStartTime && afterStartTime > 0) {
        const newTime = (0, date_fns_1.format)(new Date(afterStartTime), 'M월 d일 (E) a h:mm', {
            locale: locale_1.ko,
        });
        messages.push({
...
//# sourceMappingURL=onScheduleUpdate.js.map